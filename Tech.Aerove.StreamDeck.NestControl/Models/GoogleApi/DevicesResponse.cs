namespace Tech.Aerove.StreamDeck.NestControl.Models.GoogleApi
{
    using System;
    ...
    public partial class SdmDevicesTraits
    {
        [JsonProperty("status")]
        public string Status { get; set; }
    }

    public partial class SdmDevicesTraitsFan
    {
        [JsonProperty("timerMode")]
        public string TimerMode { get; set; }
    }

    public partial class SdmDevicesTraitsHumidity
    {
        [JsonProperty("ambientHumidityPercent")]
        public long AmbientHumidityPercent { get; set; }
    }

    public partial class SdmDevicesTraitsInfo
    {
        [JsonProperty("customName")]
        public string CustomName { get; set; }
    }

    public partial class SdmDevicesTraitsSettings
    {
        [JsonProperty("temperatureScale")]
        public string TemperatureScale { get; set; }
    }

    public partial class SdmDevicesTraitsTemperature
    {
        [JsonProperty("ambientTemperatureCelsius")]
        public double AmbientTemperatureCelsius { get; set; }
    }

    public partial class SdmDevicesTraitsThermostatEco
    {
    ...
    public partial class SdmDevicesTraitsThermostatMode
    {
        [JsonProperty("mode")]
        public string Mode { get; set; }
